...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/reponsiveUI.css">
                    ...
                    if (!isset($_SESSION['user_id'])) {
                        ...
                        echo '<li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#">Lịch hẹn của tôi</a></li>
                                </ul>
                            </li>';
                        echo '<li><a href="logout.php" class="link">Đăng xuất</a></li>';
                    }
                ?>
            </ul>
        </nav>
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <select id="doctor" name="doctor" required>
                            ...
                            <option value="doctor3">Bác sĩ 3</option>
                        </select>
                    </div>
                </div>
                <div>
...
<script src="/assets/css/UI.js"></script>
<script>
